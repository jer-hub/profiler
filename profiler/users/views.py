...
def search(request):
    ...
    user_list = User.objects.filter(Q(user_name__icontains=term) | Q(user_lname__icontains=term)).order_by('-id')
...
def processadd(request):
    ...
    try:
        ...
        user = User.objects.create(user_email=email, user_name=fname, user_lname=lname, user_position=position,
                                   user_image=user_pic)
        user.save()
